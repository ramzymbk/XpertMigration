...
namespace XpertMigration.Blazor.Server {
    public partial class XpertMigrationBlazorApplication : BlazorApplication {
        public XpertMigrationBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XpertMigrationBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
